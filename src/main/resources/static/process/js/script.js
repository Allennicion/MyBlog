...
var Froogaloop = function () {
    ...
    function c(a) {
        ...
        a = b.value;
        var c = b.data, d = d == "" ? null : b.player_id;
    ...
    var e = {}, f = !1;
    a.fn = a.prototype = {
        playerDomain: "", element: null, init: function (a) {
            typeof a === "string" && (a = document.getElementById(a));
            this.element = a;
            return this
        }, api: function (a, c) {
            if (!this.element || !a) return !1;
            var e = this.element, f = e.id != "" ? e.id : null,
        ...
        return this.each(function () {
            ...
            function bD() {
                if (b.showPause) {
                    ...
                    bk.parent().fadeOut(100, function () {
                        bd.animate({left: "70px"}, 500);
                        bc.animate({left: 0}, 500, function () {
            ...
            function bC() {
                if (b.showPause) {
                    be.parent().fadeOut(100, function () {
                        bd.animate({left: "30px"}, 500);
                        bc.animate({left: "41px"}, 500, function () {
            ...
            function bB() {
                ...
                $workSlider.find("li.active iframe").fadeOut(500, function () {
                    bx(be);
                    $workSlider.find("li.active canvas").css({display: "block"})
                });
                iframe = false
            }
            ...
            function bA() {
                ...
                if (c > 0) {
                    c / b < 1 ? Q.animate({marginTop: 0}, 300) : Q.animate({marginTop: "-" + parseInt(c - b) + "px"}, 300)
                }
            }
            ...
            function bz() {
                ...
                if (parseInt(a - c) > b) {
                    if (a / b < 2) {
                        Q.animate({marginTop: parseInt(b - parseInt(a - c)) + "px"}, 300)
                    } else {
                        parseInt(a - c) / b < 2 ? Q.animate({marginTop: "-" + parseInt(a - b) + "px"}, 300) : Q.animate({marginTop: "-" + parseInt(c + b) + "px"}, 300)
                    }
                }
            }
            ...
            function by() {
                ...
                if (e < d) {
                    if ((d - e + 75) / b < 1) {
                        d + 75 > c * 85 ? Q.animate({marginTop: "-" + parseInt(d - c * 85) + "px"}, 300) : bA()
                    } else {
                        Q.animate({marginTop: 0}, 300)
                    }
                } else if (e - d > b) {
                    if ((e - d - 95) / b > 1) {
                        Q.animate({marginTop: "-" + parseInt(a - b + 20) + "px"}, 300)
                    } else {
                        b + d + 85 < a ? Q.animate({marginTop: "-" + parseInt(c * 85 + d) + "px"}, 300) : bz()
                    }
                }
            }
            ...
            function bt() {
                if (a(".showHide a").parent().hasClass("hidden")) {
                    ...
                    a(".showHide a").parent().parent().animate({right: 0}, 500)
                } else {
                    a(".showHide a").parent().parent().animate({right: "-140px"}, 500, function () {
            ...
            function br(a) {
                if (bg) {
                    ...
                    bj.css({backgroundPosition: "-" + Math.round(Math.round(10 - 10 * (a / 110)) * 11) + "px 0"})
                }
            }
            ...
            function bp() {
                function C(c) {
                    ...
                    if (H[3] == "youtube") {
                        ...
                        if (a(c).find("#player" + j).attr("class") != "videoIframe") {
                            ...
                            a(g).find("iframe:eq(0)").css({display: "block"})
                        }
                    ...
                    if (d && b.useCanvas) {
                        $workSlider.find("li.slide" + j + " canvas:eq(0)").css({display: "none"})
                    } else {
                        $workSlider.find("li.slide" + j + " img:eq(0)").css({display: "none"})
                    }
                    g.fadeIn(500);
                    g = h = false
                }
                ...
                by();
                $workSlider.find("li.slide" + j).addClass("active").animate({opacity: 1}, 500, function () {
                    if (b.showCaptions && o) {
                        $workSlider.find("li.slide" + j + " .cmsmsSlideCaption").css({width: q + "px"});
                ...
                if (i != "undefined") {
                    $workSlider.find("li.slide" + i).animate({opacity: 0}, 1e3, function () {
                        a(this).removeClass("active");
                        if (b.showCaptions && p) {
                            ...
                            $workSlider.find("li.slide" + i + " .cmsmsSlideCaption").css({opacity: 0})
                        }
                        $workSlider.find("li").not(".slide" + j).css({opacity: 0})
                    })
                }
                F = false;
                if (e) {
            ...
            e.css({width: b.sliderWidth + "px", height: b.sliderHeight + "px"});
            var f = c.find("li");
            ...
            $workSlider.css({width: b.sliderWidth + "px", height: b.sliderHeight + "px"});
            f.each(function () {
                var c = a(this);
                ...
                if (d && b.useCanvas) {
                    ...
                    h ? $workSlider.find("li.slide" + D + " canvas").attr({id: "slideCanvas" + D}).wrap('<a href="' + e.parent().attr("href") + '" />') : $workSlider.find("li.slide" + D + " canvas").attr({id: "slideCanvas" + D});
                    ...
                    $workSlider.find("li.slide" + D + " img:eq(0)").attr({id: "slideCanvas" + D}).css({
                        width: i,
                        height: j,
                        margin: -k + " 0 0 -" + l
                    });
